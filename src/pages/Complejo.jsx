...
const Complejo = () => {
    ...
    // 3. DISCIPLINAS
    const disciplinas = [
        { nombre: "Básquet", icono: <FaBasketballBall className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Futsal", icono: <FaFutbol className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Hockey Femenino", icono: <FaHockeyPuck className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Hockey Masculino", icono: <FaHockeyPuck className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Karate", icono: <FaFistRaised className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Patín", icono: <FaSkating className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Rugby", icono: <FaFootballBall className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Tenis", icono: <FaTableTennis className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Voley", icono: <FaVolleyballBall className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> },
        { nombre: "Boxeo", icono: <GiBoxingGlove className="w-6 h-6 md:w-8 md:h-8 text-white mb-2 md:mb-3 opacity-90 group-hover:scale-110 transition-transform" /> }
    ];
    ...
    return (
        <div className="min-h-screen font-sans bg-white">
            ...
            {/* =========================================
                TARJETAS FLOTANTES (Margen Negativo)
            ========================================== */}
            <div className="relative z-20 max-w-5xl mx-auto px-4 w-full -mt-20 md:-mt-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full">
                    <div className="bg-white rounded-xl shadow-xl p-5 md:p-6 flex items-center gap-4 border-b-4 border-red-700">
                        ...
                        <div>
                            <p className="text-xs md:text-sm text-gray-500 font-bold uppercase tracking-wider">Ubicación</p>
                            <p className="text-lg md:text-2xl font-black text-gray-900">Yerba Buena</p>
                        </div>
                    </div>
                    <div className="bg-white rounded-xl shadow-xl p-5 md:p-6 flex items-center gap-4 border-b-4 border-red-700">
                        <div className="bg-red-100 p-3 rounded-lg text-red-700 shrink-0">
                        ...
                        <div>
                            <p className="text-xs md:text-sm text-gray-500 font-bold uppercase tracking-wider">Deportes</p>
                            <p className="text-lg md:text-2xl font-black text-gray-900">+10 Disciplinas</p>
                        </div>
                    </div>
                    <div className="bg-white rounded-xl shadow-xl p-5 md:p-6 flex items-center gap-4 border-b-4 border-red-700">
                        <div className="bg-red-100 p-3 rounded-lg text-red-700 shrink-0">
                        ...
                        <div>
                            <p className="text-xs md:text-sm text-gray-500 font-bold uppercase tracking-wider">Extensión</p>
                            <p className="text-lg md:text-2xl font-black text-gray-900">+23 Hectáreas</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white pt-16 md:pt-32 pb-16 md:pb-24 border-b border-gray-100 w-full">
                <div className="max-w-6xl mx-auto px-4 w-full">
                    {/* ARREGLO: grid-cols-1 explícito y min-w-0 */}
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-start w-full">
                        
                        {/* Columna Texto */}
                        <div className="w-full min-w-0">
                            <div className="flex items-center gap-3 mb-4">
                                <Users className="w-6 h-6 md:w-8 md:h-8 text-red-700 shrink-0" />
                                <h2 className="text-2xl md:text-3xl font-black text-gray-900 uppercase tracking-wide break-words">La segunda casa</h2>
                            </div>
            ...
            <div className="bg-red-800 py-16 md:py-24 w-full">
                <div className="max-w-6xl mx-auto px-4 text-center w-full">
                    <h2 className="text-2xl md:text-3xl font-black uppercase tracking-wider mb-4 text-white">Nuestras Disciplinas</h2>
                    <div className="w-20 md:w-24 h-1.5 bg-white mx-auto rounded-full mb-8 md:mb-12"></div>
                    
                    {/* ARREGLO: Gap ajustado y padding interno reducido en celular para que no reviente */}
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-6 w-full">
                        {disciplinas.map((disciplina, index) => (
                            <div key={index} className="bg-white/10 border border-red-500/30 rounded-2xl p-4 md:p-6 flex flex-col items-center justify-center hover:bg-white/20 transition-all duration-300 shadow-lg group min-w-0">
                                {disciplina.icono}
                                <h3 className="text-white font-bold uppercase tracking-wider text-[10px] md:text-sm text-center break-words">{disciplina.nombre}</h3>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <div className="bg-white py-16 md:py-24 w-full">
                <div className="max-w-6xl mx-auto px-4 text-center w-full">
                    <h2 className="text-2xl md:text-4xl font-black text-gray-900 uppercase tracking-wider mb-4">Ubicación e Infraestructura</h2>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mt-10 md:mt-16 w-full">
                        <div className="p-6 md:p-8 bg-white rounded-2xl border-t-4 border-red-700 shadow-md">
                            <Waves className="w-8 h-8 md:w-10 md:h-10 text-red-700 mx-auto mb-3 md:mb-4 shrink-0" />
                        ...
                        <div className="p-6 md:p-8 bg-white rounded-2xl border-t-4 border-red-700 shadow-md">
                            <Flame className="w-8 h-8 md:w-10 md:h-10 text-red-700 mx-auto mb-3 md:mb-4 shrink-0" />
                        ...
                        <div className="p-6 md:p-8 bg-white rounded-2xl border-t-4 border-red-700 shadow-md">
                            <Construction className="w-8 h-8 md:w-10 md:h-10 text-red-700 mx-auto mb-3 md:mb-4 shrink-0" />
                        ...
                        <div className="p-6 md:p-8 bg-white rounded-2xl border-t-4 border-red-700 shadow-md">
                            <Trees className="w-8 h-8 md:w-10 md:h-10 text-red-700 mx-auto mb-3 md:mb-4 shrink-0" />
